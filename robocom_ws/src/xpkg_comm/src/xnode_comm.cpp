...
int main(int argc, char **argv)
{
    ...
    xnode_comm.param("com_device", com_device, std::string(""));
    ...
    if(com_enable && ros::ok())
    {
        ...
        {
            m_comm_CIF_COM.COMInitDefault(com_device);
            rate_s.sleep();
        }
    ...
    while (ros::ok())
    {
        ...
        {
            if(m_comm_CIF_COM.COMInitDefault(com_device))ROS_INFO("\033[1;32mxnode_comm : COM open successfully \033[0m");
            rate_s.sleep();
        }
