...
class LineVision:
    ...
    def detect_stopline_before_crosswalk(self, binary, lane_lock_mask=None):
        ...
        for contour in contours:
            ...
            locked_edge = self._overlaps_lane_lock(contour, lane_lock_mask) >= LANE_LOCK_STOP_OVERLAP
    ...
    def _overlaps_lane_lock(self, contour, lane_lock_mask):
        ...
        if area <= 0.0:
            return 0.0
        overlap = np.count_nonzero(cv2.bitwise_and(contour_mask, lane_lock_mask))
        return overlap / area
