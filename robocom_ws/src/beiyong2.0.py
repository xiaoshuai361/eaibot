...
class LaneFollower:
    ...
    def process_frame(self):
        ...
        # 巡线模式
        if not self.slow_mode and not self.ramp_mode:
        ...
        # 7-8秒后开始识别人偶
        if 7 <= elapsed_time <= 8 and not self.slow_mode:
