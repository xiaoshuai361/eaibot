...
class RubbishDetector:
    def __init__(self, model_path="rubbish_best.pt", device='cpu', conf_thres=0.4, save_dir="saved_rubbish_images"):
        ...
        # 垃圾类别映射（与训练标签对应）
        self.class_info = {
            0: '可回收物_未投放',  # 对应 Harmful NO
            1: '厨余垃圾_已投放',  # 对应 Food OK
            2: '厨余垃圾_未投放',  # 对应 Food NO
            3: '有害垃圾_已投放',  # 对应 Recyclable OK
            4: '有害垃圾_未投放',  # 对应 Recyclable NO
            5: '其他垃圾_已投放',  # 对应 Qita OK
            6: '其他垃圾_未投放',  # 对应 Qita NO
            7: '可回收物_已投放'   # 对应 Harmful OK
        }
        ...
        try:
            ...
            # 关键修复：显式设置模型类别名称，与训练时的英文标签完全一致
            self.model.names = [
                "Recyclable NO", "Food OK", "Food NO",
                "Harmful OK", "Harmful NO",
                "Qita OK", "Qita NO", "Recyclable OK"
            ]
...
class LaneFollower:
    def __init__(self):
        ...
        self.detection_intervals = [
            ...
            {"start": 58, "end": 59, "done": False, "type": "people"},
            {"start": 70, "end": 71, "done": False, "type": "people"},
            {"start": 92, "end": 93, "done": False, "type": "fire"},  # 第二次火灾检测
            {"start": 106, "end": 107, "done": False, "type": "people"},
            {"start": 117.5, "end": 118.5, "done": False, "type": "rubbish"},  # 垃圾桶检测时段
            {"start": 130.5, "end": 131.5, "done": False, "type": "people"}
        ]
